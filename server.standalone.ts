...
// IIS named pipe or numeric port
...
const listenTarget: string | number = pipeName ?? portNumber!;
...
// Minimal config – IISNode doesn’t need the full giant object
const nextConfig = {
  env: {},
  webpack: null,
  ...
  outputFileTracingRoot: 'D:\\Practice\\nextjs\\my-app',
  experimental: {
    useSkewCookie: false,
    cacheLife: {
